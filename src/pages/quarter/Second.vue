    ...
    <div class="first_page">
        ...
        <section class="floor_fifth">
            ...
            <div class="finance-info tabs">
                <ly-tab v-model="selectedFinanceTab"
                    :items="financeTabs"
    ...
    methods: {
        ...
        async getYjzlInfo() {
            ...
            if (result.code === 1) {
                ...
                data.list.forEach((item, index) => {
                    ...
                    $(`.floor_1_main_${index + 1} .number h5`).html(
                        item.number
                    );
                    ...
                    if (item.growth > 0) {
                        ...
                        $(`.floor_1_main_${index + 1} .growth`).css(
                            'color',
                            'red'
                        );
                    } else {
        ...
        renderFinanceChart(key = 'rate') {
            ...
            let myChart = echarts.init(
                document.getElementById('floor4_1_chart')
            );
        ...
        async floor2_1_chart() {
            ...
            let myChart = echarts.init(
                document.getElementById('floor2_1_chart')
            );
        ...
        async floor2_2_chart() {
            ...
            let myChart = echarts.init(
                document.getElementById('floor2_2_chart')
            );
        ...
        async floor3_1_chart() {
            ...
            if (result.code === 1) {
                ...
                const key = this.shareholderTabs[this.selectedShareholderTab]
                    .value;
