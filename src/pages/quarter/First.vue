    ...
    <div class="first_page">
        ...
        <section class="floor_fifth">
            ...
            <div class="finance-info tabs">
                <ly-tab v-model="selectedFinanceTab" :items="financeTabs" @change="onFinanceChanged" :options="tabOptions">
                </ly-tab>
            </div>
            <div class="floor">
        ...
        <section class="floor_sixth">
            ...
            <div class="finance-info tabs">
                <ly-tab v-model="selectedShareholderTab" :items="shareholderTabs" @change="onShareholderChanged" :options="tabOptions">
                </ly-tab>
            </div>
        ...
        <section class="floor_contrast">
            ...
            <div class="contrast-info tabs">
                <ly-tab v-model="selectedContrastTab" :items="financeTabs" @change="onContracstChanged" :options="tabOptions">
                </ly-tab>
            </div>
            <div class="floor">
